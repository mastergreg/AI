...
\begin{figure}[!ht]
	\subfloat[Admissible]{\includegraphics[width=0.3\textheight]{files/Adm.png}}
	\subfloat[NonAdmissible]{\includegraphics[width=0.3\textheight]{files/NonAdm.png}}
\end{figure}
\begin{figure}[!ht]
	\subfloat[Admissible (log)]{\includegraphics[width=0.3\textheight]{files/logAdm.png}}
	\subfloat[NonAdmissible (log)]{\includegraphics[width=0.3\textheight]{files/logNonAdm.png}}
\end{figure}
