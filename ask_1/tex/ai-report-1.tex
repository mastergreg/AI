...
\begin{minipage}{0.4\textwidth}
	...
	\caption{Admissible (figure ~\ref{fig:adm})}
	\end{minipage}
\begin{minipage}{0.4\textwidth}
	\centering
	\includegraphics[width=0.3\textheight]{files/NonAdm.png}
	\caption{Non Admissible (figure ~\ref{fig:nonadm})}
	\end{minipage}
\end{figure}
...
\begin{minipage}{0.4\textwidth}
	...
	\caption{Admissible (figure ~\ref{fig:logadm})}
	\end{minipage}
\begin{minipage}{0.4\textwidth}
	\centering
	\includegraphics[width=0.3\textheight]{files/logNonAdm.png}
	\caption{Non Admissible (figure ~\ref{fig:lognonadm})}
	\end{minipage}
\end{figure}
